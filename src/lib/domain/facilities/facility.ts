...
export class Facility {
  ...
  async getDto(locale: string): Promise<FacilityDto> {
    ...
    return {
      ...
      currentStatus__term:  this._data.lifeCycle.currentStatus__taxonomyId && (await getTaxonomyReferenceTerm(
        this._data.lifeCycle.currentStatus__taxonomyId,
        locale,
      )) || "",
      ...
      operation_startYear:
        this._data.lifeCycle.operation?.startYear,
      operation_endYear:
        this._data.lifeCycle.operation?.endYear,
      isUserFacility: this._data.isUserFacility,
      isBMBF_FIS: this._data.isBMBF_FIS,
      primaryBeamParticles:
        this._data.parameters.primaryBeamParticles,
      secondaryBeamParticles:
        this._data.parameters.secondaryBeamParticles,
