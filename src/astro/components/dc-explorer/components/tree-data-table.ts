...
export const treeDataTableTileId = (
  collection: string,
  dimension: string,
) => {
  return (
...
export const treeDataTableId = (
  collection: string,
  dimension: string,
) => {
  return (
    "dc-explorer__tree-table--" +
    collection +
    "-" +
    dimension
  )
...
export function createTreeDataTableChart(
  ...
  const chartElementIdSelector =
    "#" + treeDataTableId(collection, dimension)

  const treeDataTableChart = new TreeTable(
    chartElementIdSelector,
    cfDimension,
  )
